    ...
    public partial class addTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmetSubjects", x => x.StudSubID);
                    table.ForeignKey(
                        name: "FK_DepartmetSubjects_Departments_DepartmentDID",
                        column: x => x.DepartmentDID,
                        principalTable: "Departments",
                        principalColumn: "DID");
                    table.ForeignKey(
                        name: "FK_DepartmetSubjects_Students_StudID",
                        column: x => x.StudID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmetSubjects_DepartmentDID",
                table: "DepartmetSubjects",
                column: "DepartmentDID");

            migrationBuilder.CreateIndex(
                name: "IX_DepartmetSubjects_StudID",
                table: "DepartmetSubjects",
                column: "StudID");
